  ...
  return (
    <View className="flex-1 gap-6 py-4">
      ...
      <View className="gap-3">
        <Button onPress={onBack} className="w-full" accessibilityLabel="Connect Google Calendar">
...
const meta = {
  title: "Calendars/GoogleConnectFlow",
  component: GoogleConnectFlow,
  decorators: [decorator],
  tags: ["autodocs"],
  args: {
    onBack: () => {},
  },
} satisfies Meta<typeof GoogleConnectFlow>;
